class Stage {
    constructor(name, canvas) {
        ...
        // Aqui mais uma gambiarra, lembre-se que isso esta fazendo como o comentario.
    ...
    spawnEnemy() {
        if(this.shouldSpawn){
            ...
            // O próximo inimigo a ser gerado é aleatório baseado em quantidade
            // Esse tipo ainda precisa ser gerado.
            ...
            this.enemies.push(
                new Enemy(
                    nextEnemy,
                    // Muda para que eu possa definir uma area de geraçao de inmigos.
                    point.x,
                    point.y,
                    iCtx,
                    this
