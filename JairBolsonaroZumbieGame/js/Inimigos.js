class Enemy extends GameObject{
    constructor (name, x, y, context,stage) {
        ...
        if(sprite) {
            ...
            // Analisa se a imagem foi encontrada no banco de dados.
            let img = new Image();
    ...
    move() {
        ...
        // Se o jogador nao for tocado, ele prosegue em frente.
    ...
    draw() {
        ...
        // Nao achei esse lugar ideo para esse blobo de codigo.
        this.move();
    ...
    hitTest(obj) {
        // Conserta a funçao mais dificil do jogo.
